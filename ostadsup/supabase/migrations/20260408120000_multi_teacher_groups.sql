...
create index group_invite_tokens_student_secret_idx on public.group_invite_tokens (student_join_secret);

create index group_invite_tokens_teacher_secret_idx on public.group_invite_tokens (teacher_link_secret);
...
execute procedure public.trg_insert_group_invite_tokens ();
...
create index group_staff_teacher_id_idx on public.group_staff (teacher_id);

create index group_staff_group_id_idx on public.group_staff (group_id);
...
-- Teacher group list: owned ∪ linked + is_owner flag
