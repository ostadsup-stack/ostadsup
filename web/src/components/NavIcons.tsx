/** أيقونات بسيطة للتنقل — SVG للوضوح على كل الشاشات */
...
export function IconPosts({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="22"
...
export function IconGraduation({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M6 12v5c0 2 3 3 8 3s8-1 8-3v-5" />
    </svg>
  )
}
